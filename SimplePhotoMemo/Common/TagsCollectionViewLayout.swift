...
class TagsCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    func setup(cellSizes:[CGSize],
        ...
        var currentPoint:CGPoint = CGPoint(x: collectionViewInset.left, y: collectionViewInset.top)
        ...
        for (i, size) in cellSizes.enumerated() {
            ...
            if (currentPoint.x + size.width <= collectionViewWidth - collectionViewInset.left - collectionViewInset.right) {
                ...
                if (currentPoint.x + size.width <= collectionViewWidth - collectionViewInset.left - collectionViewInset.right) {
                    ...
                    // 収まらない
                    currentPoint = CGPoint(x: collectionViewInset.left, y: currentPoint.y + verticalMargin + currentRowHeight)
                    currentRowHeight = 1
